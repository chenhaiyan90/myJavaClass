	...
	private static String mobileGateWayHeaders[]=new String[]{
	 ...
	 public static boolean isMobileDevice(HttpServletRequest request){
		...
		public static boolean isWeixinBrowser(HttpServletRequest request) {
			...
			if (!StringUtils.isEmpty(ua) && ua.indexOf("micromessenger") > 0) { // 是微信浏览器
				return true;
			}
			return false;
		}
		...
		// 移动：134、135、136、137、138、139、150、151、152，157(TD)、158、159、182/183/184/187/188/147/178
		// 联通：1130/131/132/155/156/185/186/145/176
